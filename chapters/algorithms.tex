...
Реализация алгоритмов выполнена на языке программирования C++ с использованием стандартной библиотеки \cite{cppreference}. Выбор языка обусловлен его высокой производительностью и отсутствием накладных расходов, что важно для точного измерения времени выполнения.
